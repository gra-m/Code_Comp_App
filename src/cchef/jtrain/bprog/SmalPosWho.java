...
static final String OUTPUT_PATH = "/home/kali/Documents/001_CC/smwhout.txt";
...
// I worked this out from the start.. it was just a simple modulo problem..
            if(kase > 0) {
                  if( k > 0 ) {
                        /*original*/
                        //while( n - k >= 0 ) n -= k;
                        long denominator = Math.floorDiv(n, k);
                        n-=denominator*k;   // == n%k

                        //shortcut divide n by the smaller k 123/10 = 12.3
                        //n = n-= 12 * k
                        // or if n/k == exact and n is even 0
                        // or if n/k == exact and n is odd 1
                  }
                  //OUT.print(kase + " ");
                  //if( n < 0 ) n += k;
                  OUT.print(n);
