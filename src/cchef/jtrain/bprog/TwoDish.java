...
public static void main(String[] args) throws Exception {
	...
	while (t-- > 0) {
		...
		int a = Integer.parseInt(arr[1]); //fruits
		int b = Integer.parseInt(arr[2]); // vegetables
		int c = Integer.parseInt(arr[3]); // fish
		int maxDishes = Math.min((a + c), b);

		OUT.println(maxDishes >= n ? "YES" : "NO");
