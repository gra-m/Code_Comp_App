package cchef.jtrain.starters80;           //single use attack
...
public static void main(String[] args) throws Exception {
	...
	while (t-- > 0) {
		int h_bossHealth = s.nextInt();
		int x_normal = s.nextInt();
		int y_special = s.nextInt();
		int total = 0;
		int count = 0;

		for (total = 0; total < h_bossHealth; ) {
