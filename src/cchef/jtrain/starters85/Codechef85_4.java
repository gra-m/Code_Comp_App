...
class Codechef85_4 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    while (t-- > 0) {
      kase++;
      String noNeedForBigDecimal = IN.cleanDigitsSpaces();
      String base10DivPoint = "20";
      int checkingTheLastTwoFor20 = 0;

      if (kase > 0) {
        if (noNeedForBigDecimal.length() > base10DivPoint.length()-1)
          checkingTheLastTwoFor20 =
              Integer.parseInt(
                  noNeedForBigDecimal.substring(
                      noNeedForBigDecimal.length() - base10DivPoint.length()));
        else checkingTheLastTwoFor20 = Integer.parseInt(noNeedForBigDecimal);
        OUT.println(checkingTheLastTwoFor20%Integer.parseInt(base10DivPoint));
      }
    }
